...
1. Extract CodingExercise.zip to C:\temp or clone repo at https://github.com/vinhchung/codingexercise
2. Open command prompt in admin mode and change to path of project folder CodingExercise.
...
1. Extract CodingExercise.zip or clone repo at https://github.com/vinhchung/codingexercise
2. Open terminal and go to project folder CodingExercise.
3. type command: dotnet restore
